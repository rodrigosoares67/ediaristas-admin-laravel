            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="icone" id="icone" class="form-control">
                      ...
                      <option value="twf-cleaning-1" {{ old('icone', isset($servico) && $servico->icone)</option> === "twf-cleaning-1" ? 'selected' : '' }}>Ícone 1</option>
                      <option value="twf-cleaning-2" {{ old('icone', isset($servico) && $servico->icone)</option> === "twf-cleaning-2" ? 'selected' : '' }}>Ícone 2</option>
                      <option value="twf-cleaning-3" {{ old('icone', isset($servico) && $servico->icone)</option>=== "twf-cleaning-3" ? 'selected' : '' }}>Ícone 3</option>
                    </select>
                </div>
            </div>
            <div class="col-md-4">
